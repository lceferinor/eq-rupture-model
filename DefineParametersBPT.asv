%% Define parameters for rupture occurrence: (Ceferino et al. BSSA (2018))
% Developed by: Luis Ceferino
% Date: 02/21/2017


%% MLE Estimation (Formula from Tweedie 1957)
% General geometry
N_Rupture_zones = 8;            % Number of sections
L_tot = 620;                    % Total length of the fault
L_rup = L_tot/N_Rupture_zones;  % Rupture length of each section

% Data of interarrival times
t0 = [2007 2007 1974 1974 1974 1966 1966 1746]; % Last time (year) of 
...
T = 320;
BPT_a(1) = 0.7; % Assumed, it cannot be calculated
BPT_a(1) = 0.7 
